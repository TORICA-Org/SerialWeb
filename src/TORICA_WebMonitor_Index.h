...
<body>
  ...
  <script type='text/javascript'>
   ...
   ws.onopen = () => {
     ...
     const element = document.getElementById("constantMessage");
      element.textContent += "<br>WebSocket connected";
   };

   ws.onclose = () => {
     console.log("WebSocket disconnected");
     const element = document.getElementById("constantMessage");
      element.textContent += "<br>WebSocket disconnected";
   };

   ws.onmessage = (event) => {
     console.log(`Received: ${event.data}`);
     const element = document.getElementById("constantMessage");
      element.textContent += "<br>Received: ${event.data}";
   };
